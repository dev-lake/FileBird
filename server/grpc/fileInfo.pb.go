...
var file_proto_fileInfo_proto_rawDesc = []byte{
	...
	0x73, 0x44, 0x69, 0x72, 0x32, 0xb9, 0x01, 0x0a, 0x08, 0x46, 0x69, 0x6c, 0x65, 0x49, 0x6e, 0x66,
...
var file_proto_fileInfo_proto_depIdxs = []int32{
	...
	0, // 3: FileInfo.IsFileExist:input_type -> FileReq
	0, // 4: FileInfo.FileIsDir:input_type -> FileReq
	1, // 5: FileInfo.GetFileInfo:output_type -> RegularFileInfo
	2, // 6: FileInfo.GetDirFileInfo:output_type -> DirFileInfoList
	3, // 7: FileInfo.IsFileExist:output_type -> FileExistRep
	4, // 8: FileInfo.FileIsDir:output_type -> FileIsDirRep
